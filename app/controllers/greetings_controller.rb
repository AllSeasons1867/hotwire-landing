class GreetingsController < ApplicationController
  ...
  def index
    @greetings = Greeting.order("id DESC").all
  ...
  def create
    ...
    respond_to do |format|
      if @greeting.save
        ...
        format.turbo_stream { render turbo_stream: turbo_stream.replace(@greeting, partial: 'greetings/form', locals: {greeting: @greeting}) }
      end
    end
  end
  ...
  private
    ...
    def greeting_params
      params.require(:greeting).permit(:body, :content)
    end
end
